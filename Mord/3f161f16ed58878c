...
entries: map[hash,embed] = {
    "Characters/Mordekaiser/Skins/Skin0/Particles/Mordekaiser_Base_Passive_Hit_Enemy" = VfxSystemDefinitionData {
            ...
            VfxEmitterDefinitionData {
                ...
                ChildParticleSetDefinition: pointer = VfxChildParticleSetDefinitionData {
                    ChildrenIdentifiers: list[embed] = {
                        VfxChildIdentifier {
                            EffectKey: hash = "Mordekaiser_Passive_Hit_Streak_Enemy"
                        }
                    }
                }
        ...
        ParticleName: string = "Mordekaiser_Base_Passive_Hit_Enemy"
        ParticlePath: string = "Characters/Mordekaiser/Skins/Skin0/Particles/Mordekaiser_Base_Passive_Hit_Enemy"
    }
}
